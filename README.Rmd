...
Faça *co-assembly* para *datasets* com distâncias menores de 0.1, entre ellas. Como pode ser observado, se formaram dois grandes cluster as amostras 1 a 3 e amostras 4 a 6. No entanto, os dois clusters são proóximos entre eles. Por tanto podem ser montados todos em um co-assembly só. 
...
Finalmente é necessário construir uma tabela final com todas as anotações (taxonômica e funcional) de todas as montagens. 
