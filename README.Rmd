...
```
Descarregue os arquivos `.npo` e o arquivo `Samples.txt`. Usando o seguinte script do R, grafique as curvas de saturação. *Nota: todos os arquivos descarregados devem estar dentro de uma pasta só, p.e. `03.NonPareil`.
