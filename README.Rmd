...
Esta etapa é para identificar principalmente as sequências **outlier* com baixa qualidade ($Phred Score < 20$)
...
>
> Ésta etapa es para identificar principalmente las secuencias *outlier* con baja calidad ($Phred Score < 20$).
>
